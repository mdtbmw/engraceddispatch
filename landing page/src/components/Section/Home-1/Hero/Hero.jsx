      ...
      <div
        ...
        <div className="container">
          <motion.div
            ...
            animate="visible"
          >
            <motion.h1 variants={itemVariants}>Delivery at your fingertips</motion.h1>
            <motion.p variants={itemVariants}>
              Dispatch brings fast, reliable bike and courier
              delivery across Benin City straight to your phone. Send packages,
              track in real-time, and pay seamlessly — all from one app.
            </motion.p>
