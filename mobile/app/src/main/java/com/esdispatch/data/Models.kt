...
data class Parcel(
    ...
    val reservedRiderId: String = "",
    val reservedCourierName: String = "",
    val reservedCourierPhone: String = "",
    val podUrl: String = "",
...
data class Transaction(
    ...
    val type: String = if (isTopUp) "CREDIT" else "DEBIT", // "CREDIT" or "DEBIT"
    val status: String = "SUCCESS", // "PENDING", "SUCCESS", "FAILED"
    val reference: String = "", // Paystack reference or Parcel ID
    val userId: String = "" // Important for Firestore
)
